  ...
  switch (diagnostic.code) {
    case "MISSING_FIELD":
      return {
        ...
        suggestion: `请补全${fieldName}，然后${action}`,
      };
    case "UNKNOWN_FIELD":
      return {
    ...
    case "INVALID_TYPE":
      return {
        ...
        suggestion: `请按装备包格式要求修正该字段，然后${action}`,
      };
    case "INVALID_ENUM":
      return {
        description: `${fieldName}不是装备包支持的选项`,
        suggestion: `请从装备包支持的选项中选择，然后${action}`,
      };
    case "FIELD_TOO_LONG":
      return {
        description: "该字段内容过长",
        suggestion: `请缩短该字段内容，然后${action}`,
      };
    case "DUPLICATE_ID":
      return {
        description: "装备 ID 重复",
        suggestion: `请修改其中一个重复 ID，确保每件装备唯一，然后${action}`,
      };
    case "ID_CONFLICT":
      return {
    ...
    case "DESCRIPTION_LONG":
      return {
        ...
        suggestion: `建议精简描述内容，然后${action}`,
      };
    case "SOURCE_READ_FAILED":
      return {
        description: "无法读取装备包来源",
        suggestion: `请确认文件可以被读取，然后${action}`,
      };
    case "INVALID_JSON":
      return {
        description: "文件不是有效的 JSON",
        suggestion: `请修复 JSON 语法，然后${action}`,
      };
    case "INVALID_FORMAT":
      return {
    ...
    case "TEMPLATE_ID_CONFLICT":
      return {
        ...
        suggestion: `请修改冲突的装备 ID，然后${action}`,
      };

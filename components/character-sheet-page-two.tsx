...
import { CharacterFormDataEditProps } from "@/lib/form-data"
...
export default function CharacterSheetPageTwo({ formData, setFormData }: CharacterFormDataEditProps) {
  // 模态框状态
  ...
  const isUpgradeChecked = (tier: string, index: number): boolean => {
    return !!formData.checkedUpgrades?.[tier as keyof typeof formData.checkedUpgrades]?.[index]
  }

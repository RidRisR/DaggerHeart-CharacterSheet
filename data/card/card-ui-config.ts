...
export const CARD_CLASS_OPTIONS = {
  profession: ["战士", "法师", "游侠", "盗贼", "牧师", "德鲁伊", "圣骑士", "术士", "武僧", "诗人"],
  ancestry: ["人类", "精灵", "矮人", "半身人", "兽人", "龙裔", "提夫林", "侏儒", "半精灵", "半兽人"],
...
export const CARD_CLASS_OPTIONS_BY_TYPE = {
  ...
  attack: CARD_CLASS_OPTIONS.attack.map(value => ({ value, label: value })),
  defense: CARD_CLASS_OPTIONS.defense.map(value => ({ value, label: value })),

...
export class StorageAdapter {
    ...
    private useUnifiedStorage: boolean = false;
    ...
    async initialize(): Promise<void> {
        try {
            // 检查是否应该使用新的统一存储
            const hasMigrated = StorageMigration.validateMigration();
            this.useUnifiedStorage = hasMigrated;

            logDebug('initialize', { 
                useUnifiedStorage: this.useUnifiedStorage,
                hasMigrated 
            });
